...
(function() {
  ...
  if (ogImage && ogImage.getAttribute('content').indexOf('http') !== 0) {
    var a = document.createElement('a');
    a.href = ogImage.getAttribute('content');
    ogImage.setAttribute('content', a.href);
  }

  var twitterImage = document.querySelector('meta[property="twitter:image"]');
  if (twitterImage && twitterImage.getAttribute('content').indexOf('http') !== 0) {
    var a = document.createElement('a');
    a.href = twitterImage.getAttribute('content');
    twitterImage.setAttribute('content', a.href);
  }
