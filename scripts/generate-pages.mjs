...
const pages = [
  ...
  },
  {
    ...
    body: `<h1>Privacy Policy</h1><p>GlobalToolsHub is designed around browser-first tools. Many tools process input locally in your browser and do not require account creation.</p><h2>Analytics</h2><p>The site includes a Google Analytics tag loaded by the SEO runtime. It is used only for site performance and usage reporting.</p><h2>Local Storage</h2><p>Preferences such as theme, language, country, background style, and view mode may be stored in your browser.</p><h2>Files And Inputs</h2><p>Tools that process files should be reviewed individually before production launch, but the intended design is local browser processing wherever possible.</p>`,
  },
  {
    file: "terms.html",
    title: "Terms",
